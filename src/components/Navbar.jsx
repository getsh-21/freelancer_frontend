        ...
        <div className="flex items-center gap-4">
          {user ? (
            <>
              ...
              <Link to="/messages" className="text-gray-600 hover:text-sky-600 font-medium">
                Messages
              </Link>
              <NotificationBell />
            ...
            <>
              ...
              <Link
                to="/register"
                className="bg-sky-500 text-white px-4 py-2 rounded-lg hover:bg-sky-600 text-sm font-medium"
              >
                Sign Up
              </Link>
            </>
